...
{
    CubePipelineInterpreter interpreter;
     ...
     */
    public NetworkTableWriter(CubePipelineInterpreter interpreter, NetworkTable publishingTable) {
     ...
     */
    public void write() {
        publishingTable.putBoolean(getCubeFoundKey(), interpreter.cubesFound());
        publishingTable.putNumber(getCubeCountKey(), interpreter.cubeCount());
    }
     ...
     */
    public abstract String getCubeFoundKey();
     ...
     */
    public abstract String getCubeCountKey();
}